                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body contact-form">
                        	<div class="row">
                                <form:form action="contact-us.htm" method="post" modelAttribute="reply">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label sr-only" for="name"></label>
                                            <form:input path="name" id="name" type="text" placeholder="Your  Name" class="form-control" required="required"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label sr-only" for="phone"></label>
                                            <form:input path="phone" id="phone" type="text" placeholder="Enter your Mobile Number" class="form-control" required="required"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label sr-only" for="email"></label>
                                            <form:input path="email" id="email" type="text" placeholder="Enter Email Address" class="form-control" required="required"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label sr-only" for="name"></label>
                                            <form:input path="subject" id="subject" type="text" placeholder="Your Subject" class="form-control" required="required"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label sr-only" for="textarea"></label>
                                            <form:textarea path="messages" class="form-control" id="textarea" name="textarea" rows="4" placeholder="Messages"></form:textarea>
                                        </div>
